...
export DATASET_ROOT=dataset_git/barx3_i100_p100_u100
export CAMERAS="observation.images.robot0_agentview_right observation.images.robot0_eye_in_hand"
export USE_WRIST_CAM=true
