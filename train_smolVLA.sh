...
CUDA_VISIBLE_DEVICES=0 python src/lerobot/scripts/lerobot_train.py \
  ...
  --dataset.root="/home/kwonmc/jiyun/lerobot-VAI/dataset_git/libero_spatial_no_noops_island_1_lerobot/DP_wrist_10_10_0.0_0.0/v3.0" \
  ...
  --num_workers=16 \
  --job_name="smolvla_spatial_wo_2_4_trace_concat" \
...
# CUDA_VISIBLE_DEVICES=0 python src/lerobot/scripts/lerobot_train.py \
#   --dataset.repo_id=[v-1.000-1.000_num1,v-1.000-1.000_num2,v-1.000-1.000_num3,v-1.000-1.000_num4,v-1.000-1.000_num5,v-1.000-1.000_num6,v-1.000-1.000_num7,v-1.000-1.000_num8,v-1.000-1.000_num9,v-1.000-1.000_num10] \
#   --dataset.root="/home/kwonmc/jiyun/lerobot-VAI/dataset_git/libero_object_reproduce" \
#   --policy.type="smolvla" \
#   --policy.push_to_hub=false \
#   --steps=100000 \
#   --save_freq=5000 \
...
#   --wandb.entity="DynamicVLA" \
#   --num_workers=16 \
#   --job_name="smolvla_vanilla_object" \
